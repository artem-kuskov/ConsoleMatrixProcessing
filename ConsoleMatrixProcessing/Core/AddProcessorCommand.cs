...
{
    public class AddProcessorCommand : BaseProcessorCommand, IProcessorCommand
    {
        public override void Calculate()
        {
            ...
            foreach (Matrix<int> matrix in Source)
            {
                ...
                AddMatrix(resultMatrix, matrix, Id);
            }
        ...
        private void AddMatrix(Matrix<int> resultMatrix, Matrix<int> matrix, string id)
        {
            ...
            else
            {
                ...
                {
                    throw new FormatException($"Adding matrices have different size in data source {id}");
                }
            }
        ...
        {
            return Equals(obj as AddProcessorCommand);
        }

        public bool Equals(AddProcessorCommand other)
        {
